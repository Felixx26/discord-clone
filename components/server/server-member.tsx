...
const roleIconMap = {
	...
	[MemberRole.MODERATOR]: <ShieldCheck className="h-4 w-h ml-2 text-indigo-500" />,
	[MemberRole.ADMIN]: <ShieldAlert className="h-4 w-h ml-2 text-rose-500" />,
};
	...
	return (
		<button
			className={cn(
				...
				params?.memberId === member.id && 'bg-zinc-700 dark:bg-zinc-700/50',
			)}
		>
			<UserAvatar
